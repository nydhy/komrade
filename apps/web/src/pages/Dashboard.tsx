  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header animate-in">
        ...
        <div className="mt-3 flex-center gap-sm" style={{ justifyContent: 'flex-start' }}>
          <a href="/ladder" className="btn btn-secondary btn-sm">Open Ladder</a>
          <a href="/translate" className="btn btn-ghost btn-sm">Open Translate</a>
        </div>
      </div>
